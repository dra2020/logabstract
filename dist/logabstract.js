...
Object.defineProperty(exports, "__esModule", { value: true });
exports.ILogger = { dump: dump, log: log, event: event, error: error, value: value };
function dump() {
}
exports.dump = dump;
function log(o, verbosity = 0) {
    console.log(JSON.stringify(o));
}
exports.log = log;
function event(o, verbosity = 0) {
    if (typeof o === 'string')
        o = { event: o };
    o.kind = 'event';
    log(o, verbosity);
